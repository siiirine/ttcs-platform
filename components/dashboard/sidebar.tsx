  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-[260px]" style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '14px', fontWeight: 700, color: titleCol, letterSpacing: '0.05em', transition: 'color 0.3s' }}>ERICSSON</div>
          <div style={{ fontSize: '10px', color: '#0082f0', textTransform: 'uppercase', letterSpacing: '0.08em' }}>TTCS PLATFORM</div>
        </div>
      </div>
